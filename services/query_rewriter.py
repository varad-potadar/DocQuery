    ...
    try:
        ...
        response = client.models.generate_content(
            ...
            config=types.GenerateContentConfig(
                ...
                # the budget meant for the actual rewritten question (same
                # issue fixed in qa_engine.py's main answer call). This was
                # likely why rewriting was quietly failing and falling back
                # to the original question most of the time.

...
# Token budget
# ------------------------------------------------------------------
# Groq's free tier for llama-3.1-8b-instant caps requests at 6,000
# tokens/minute (input + reserved output combined). We stay well under
# that so a single call never gets rejected with a 413 rate_limit_exceeded.
#
...
Answer:"""
    ...
    #    rate-limit errors (429/413 from Groq's TPM limiter).
    max_retries = 3
    answer = None
